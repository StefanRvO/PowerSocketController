...
enum Message_Type : uint16_t
{
    ...
    reboot              = 0x0011, //Request a reboot
    get_wifi_ssid       = 0x0012, //Request wifi_ssid
    wifi_ssid_info      = 0x0013, //Message with the wifi_ssid of source device. Payload [string 0x00 terminated]
    set_wifi_ssid       = 0x0014,   //set wifi_ssid. Payload [string 0x00 terminated]
    get_wifi_password   = 0x0015, //Request wifi password.
    wifi_password_info  = 0x0016, //Message with the wifi_password of source device. Payload [string 0x00 terminated]
    set_wifi_password   = 0x0017,   //set wifi password. Payload [string 0x00 terminated]
